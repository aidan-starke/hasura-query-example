	...
	return (
		<div className="h-screen w-screen p-8 m-auto justify-center">
			<div className="justify-center w-2/3 m-auto">
				<h2 className="text-xl font-mono font-semibold mb-6">Posts</h2>
				<div className="space-y-6">
					{(data?.posts ?? posts).map((post) => (
						<div
							key={post.id}
							className="p-4 border-2 border-pink-200 rounded space-y-2"
						>
							...
							<div className="flex items-center text-sm">
								...
								<p>
									At:&nbsp;
									<span className="font-mono text-xs">{post.created_at}</span>
								</p>
							</div>
						</div>
					))}
